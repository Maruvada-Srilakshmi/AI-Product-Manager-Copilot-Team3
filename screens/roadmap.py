...
from utils.helpers import fetch_documents, ws_id
...
def show_roadmap():
    ...
    selected_title = st.selectbox("Select Feature to Plan", prds["title"].tolist())
    ...
    if roadmaps.empty:
        st.warning(f"No Implementation Roadmap exists for '{selected_title}' yet.")
